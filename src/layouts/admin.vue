                  ...
                  <el-dropdown-item :icon="Setting">
                    <router-link to="/admin/download-link/setting">直/短链设置</router-link>
						...
						<router-link to="/admin/user-manager"
												 :class="currentActive === '/admin/user-manager' ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'"
												 class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
							<el-icon size="18px">
								<i-ep-setting class="mr-1"/>
							</el-icon>
          ...
          <Menu as="div" class="ml-3 relative">
            <div>
              <MenuButton
                ...
                <img v-if="userStore.avatar" class="h-8 w-8 rounded-full"
      ...
      <div class="pt-2 pb-4 space-y-1">
        ...
        <DisclosureButton
          ...
          <router-link to="/admin/view-setting">显示设置</router-link>
				...
				<DisclosureButton
					:class="
						currentActive === '/admin/user-manager'
							? 'bg-indigo-50 border-indigo-500 text-indigo-700'
							: 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700'
					"
					as="a" class="block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
					<router-link to="/admin/user-manager">用户管理</router-link>
				</DisclosureButton>

				<DisclosureButton
					:class="
						currentActive === '/admin/role-manager'
							? 'bg-indigo-50 border-indigo-500 text-indigo-700'
							: 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700'
					"
					as="a" class="block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
					<router-link to="/admin/role-manager">角色管理</router-link>
				</DisclosureButton>
