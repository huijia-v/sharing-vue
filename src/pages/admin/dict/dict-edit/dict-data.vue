...
import useDictStore from '~/composables/modules/dict'
import {listData, getData, delData, addData, updateData} from '~/api/dict/data'
import {optionselect as getDictOptionselect, getType} from '~/api/dict/type'
...
const dataRef = ref<InstanceType<typeof ep.ElForm>>()
...
function getList() {
	...
	listData(queryParams.value).then(response => {
		console.log('listData-response', response);
...
// onMounted(() => {
// 	let dictId = route.params.dictId;
