...
const dictRef = ref<InstanceType<typeof ep.ElForm>>()
...
const editDictData = (dictId) => {
	router.push('/admin/dict/dict-edit/' + dictId);
}
getList();
</script>
				...
				<el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
					...
					<el-table-column label="字典类型" align="center" :show-overflow-tooltip="true" >
						<template #default="scope">
							<router-link :to="'/admin/dict/dict-edit/' + scope.row.dictId" class="link-type">
