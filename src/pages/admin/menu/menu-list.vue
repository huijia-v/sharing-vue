...
import { handleTree } from '~/utils/sharing'
...
const menuRef = ref<InstanceType<typeof ep.ElForm>>()
...
function getList() {
	...
	listMenu(queryParams.value).then((response) => {
		console.log('listMenuResponse', response.data)
...
<template>
	<div>
		<z-form>
			<template #form-title> 菜单列表 </template>
			<template #form-sub-title> 此页面显示菜单权限列表 </template>
